...
const questions = [
  {
    numb: 1,
    question: "What is the primary purpose of load balancing in a system?",
    answer: "To distribute incoming requests evenly across multiple servers",
    options: [
      "To increase storage capacity",
      "To distribute incoming requests evenly across multiple servers",
...
{
    numb: 2,
    question: "Which of the following databases is typically used for handling unstructured data?",
    answer: "NoSQL",
    options: [
      "SQL",
      "NoSQL",
...
{
    numb: 3,
    question: "In system design, what is caching used for?",
    answer: "To store frequently accessed data to improve retrieval speed",
    options: [
      "To back up data",
      "To distribute traffic",
      "To store frequently accessed data to improve retrieval speed",
...
},
{
    ...
    options: [
      ...
      "To connect databases to servers"
    ]
},
{
    numb: 5,
  ...
  return (
    ...
    <div className={`mb-10 w-full flex justify-evenly ${assessment.assessment10 === 0 ? 'block' : 'hidden'}`}>
        <h1 className='text-3xl text-blue-400 font-semibold'>SD</h1>
