...
const questions = [
  {
    numb: 1,
    question: "What is the primary purpose of image processing?",
    answer: "To enhance image quality and extract useful information",
    options: [
      "To compress images only",
      "To increase color saturation",
      "To enhance image quality and extract useful information",
      "To remove all colors from an image"
    ]
},
{
    numb: 2,
    question: "Which of the following is a common technique for image smoothing?",
...
{
    numb: 3,
    question: "What is a histogram in the context of image processing?",
    answer: "A graphical representation of the distribution of pixel intensities",
    options: [
      "A chart showing file sizes",
      "A graphical representation of the distribution of pixel intensities",
      "A measure of image brightness",
      "A table listing color values"
    ]
},
{
    numb: 4,
    question: "Which transformation is used to shift an image in the spatial domain?",
    answer: "Translation",
    options: [
      "Rotation",
      "Scaling",
...
{
    numb: 5,
    question: "In edge detection, which operator is used to find the gradient magnitude?",
    answer: "Sobel Operator",
    options: [
      "Gaussian Operator",
      "Fourier Transform",
      "Sobel Operator",
  ...
  return (
    ...
    <div className={`mb-10 w-full flex justify-evenly ${assessment.assessment8 === 0 ? 'block' : 'hidden'}`}>
        <h1 className='text-3xl text-blue-400 font-semibold'>DIP</h1>
